...
namespace BowlingGameScoreCalculator.Tests
{
    ...
    public class FrameValidation_Tests
    {
        ...
        public void Validate_FrameCantStartWith_SpareSymbol()
        {
            ...
            consoleInput.ValidateStringInput(input).Should().Be("Entered string can't start with this character.\n");
        }
        ...
        public void Validate_FrameCantHaveMoreThanOne_X()
        {
            ...
            consoleInput.ValidateStringInput(input).Should().Be("Entered string contains two 'X' in one frame.\n");
        }

        [TestMethod]
        public void Validate_FrameScoreCantExceedTen1()
        {
            var input = "999|77|93||-8|8/|-6|X|X|9-||";

            consoleInput.ValidateStringInput(input).Should().Be("Sum of one frame can not exceed 10 points.\n");
        }

        [TestMethod]
        public void Validate_FrameScoreCantExceedTen2()
        {
        ...
        public void Validate_FrameCantHaveMoreThanOne_SpareSymbol()
        {
            ...
            consoleInput.ValidateStringInput(input).Should().Be("Entered string contains two '/' symbols in one frame.\n");
        }
    }
}
